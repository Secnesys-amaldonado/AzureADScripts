if (!(Get-Module AzureAD -ListAvailable | ? {($_.Version.Major -eq 2 -and $_.Version.Build -gt 0 -and $_.Version.Revision -gt 55) -or ($_.Version.Major -eq 2 -and $_.Version.Build -eq 1)})) { Write-Host -BackgroundColor Red "This script requires a recent version of the AzureAD PowerShell module. Download it here: https://www.powershellgallery.com/packages/AzureAD/"; return}
...
foreach ($ServicePrincipal in $ServicePrincipals) {
    ...
    Write-Host "Gathering information about"$ServicePrincipal.DisplayName -ForegroundColor DarkYellow
